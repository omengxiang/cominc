...
#if (ULLONG_MAX >> 16) >> 16 != 0xffffffff && ULLONG_MAX != 0xffffffff
 #error LONG LONGS TOO LARGE FOR _Stoull
#endif /* long longs too large */

#define BIG_TABLE	(ULLONG_MAX >> 16) >> 16 == 0xffffffff
...
_CRTIMP2_PURE unsigned long long __CLRCALL_PURE_OR_CDECL _Stoullx(const char *s, char **endptr,
	int base, int *perr)
...
_CRTIMP2_PURE unsigned long long __CLRCALL_PURE_OR_CDECL _Stoull(const char *s, char **endptr, int base)
