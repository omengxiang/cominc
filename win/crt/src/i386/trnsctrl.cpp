...
*/
    ...
    result = __InternalCxxFrameHandler( pExcept, pRN, (PCONTEXT)pContext, pDC, pFuncInfo, 0, nullptr, FALSE );
...
extern "C" EXCEPTION_DISPOSITION __cdecl _TranslatorGuardHandler(
    ...
    if (IS_UNWINDING(PER_FLAGS(pExcept)))
        ...
        // Check for a handler:
        //
        __InternalCxxFrameHandler( pExcept, pRN->pRN, (PCONTEXT)pContext, nullptr, pRN->pFuncInfo, pRN->CatchDepth, pRN->pMarkerRN, TRUE );
